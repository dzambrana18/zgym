    ...
    days: [
      {
        ...
        exercises: [
          ...
          { key: 'a-remo-polea-neutro', pattern: 'remo-horizontal', name: 'Remo sentado en polea, agarre neutro', cue: 'Pausa de 1 s en contracción, escápulas atrás y abajo.', video: 'remo+sentado+en+polea+tecnica', sets: 3, repMin: 10, repMax: 12, rir: 2, restSec: 120, startLoad: 28, unit: 'kg', increment: 2.5 },
          ...
          { key: 'a-laterales', pattern: 'elevacion-lateral', name: 'Elevaciones laterales', cue: 'Sube hasta la horizontal, baja en 2-3 s. Cero impulso de cadera.', video: 'elevaciones+laterales+tecnica', sets: 3, repMin: 12, repMax: 15, rir: 1, restSec: 75, startLoad: 3, unit: 'kg-por-mano', increment: 1 },
          { key: 'a-face-pull', pattern: 'face-pull', name: 'Face pull en polea alta', cue: 'Superserie con el anterior. Codos altos, rotación externa al final. Clave para tu hombro.', video: 'face+pull+tecnica', sets: 3, repMin: 15, repMax: 20, rir: 1, restSec: 60, startLoad: 12, unit: 'kg', increment: 2.5 },
          ...
          { key: 'a-triceps-cuerda', pattern: 'extension-triceps', name: 'Extensión de tríceps en polea con cuerda', cue: 'Superserie con el curl. Codos pegados al costado.', video: 'extension+de+triceps+en+polea+con+cuerda+tecnica', sets: 2, repMin: 12, repMax: 15, rir: 1, restSec: 60, startLoad: 12, unit: 'kg', increment: 2.5 },
      ...
      },
      {
        ...
        exercises: [
          { key: 'a-remo-mancuerna', pattern: 'remo-mancuerna', name: 'Remo con mancuerna, apoyada en banco', cue: 'Una mano y una rodilla en el banco. 8-10 por brazo. Cuando domines la técnica, pasa a barra.', video: 'remo+con+mancuerna+a+una+mano+tecnica', sets: 4, repMin: 8, repMax: 10, rir: 2, restSec: 120, startLoad: 12, unit: 'kg', increment: 2 },
          ...
          { key: 'a-lateral-inclinado', pattern: 'lateral-inclinado', name: 'Elevación lateral tumbada en banco inclinado', cue: 'Banco a 45°, tumbada de lado, una mancuerna con el brazo de arriba. Se siente completamente distinto a la del lunes: aquí lo más duro es el inicio del recorrido, no el final. Peso mucho menor de lo que esperas.', video: 'elevacion+lateral+tumbado+en+banco+inclinado+tecnica', sets: 3, repMin: 12, repMax: 15, rir: 1, restSec: 75, startLoad: 3, unit: 'kg-por-mano', increment: 1 },
          { key: 'a-encogimientos', pattern: 'encogimiento', name: 'Encogimientos de hombro con mancuernas', cue: 'Sube los hombros rectos hacia las orejas, sin rotar. Pausa de 1 s arriba. El trapecio no lo trabajabas de forma directa y es lo que da densidad a la parte alta de la espalda.', video: 'encogimientos+de+hombro+trapecio+tecnica', sets: 3, repMin: 12, repMax: 15, rir: 1, restSec: 60, startLoad: 10, unit: 'kg-por-mano', increment: 1 },
