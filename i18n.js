...
export const UI_ES = {
  ...
  suGoalRace: 'Preparar una prueba de resistencia',
  suAboutYou: 'Sobre ti',
  suTraining: 'Tu entrenamiento',
  suMinutes: 'Cuánto te dura una sesión',
  suMin30: '30 min',
  suMin45: '45 min',
  suMin60: '1 hora',
  suMin75: 'Más de 1 hora',
  suSport: 'Otro deporte además del gimnasio',
  suSportNone: 'Ninguno',
  suSportRun: 'Correr o trail',
  suSportBike: 'Bici',
  suSportSwim: 'Natación',
  suSportTeam: 'Deporte de equipo',
  suSportOther: 'Otro',
  suSportDays: 'Días de ese deporte por semana',
  suNiggle: 'Alguna molestia',
  suNiggleNone: 'Ninguna',
  suNiggleShoulder: 'Hombro',
  suNiggleKnee: 'Rodilla',
  suNiggleBack: 'Espalda baja',
  suNiggleNote: 'Si marcas una, se quitan los ejercicios que más la cargan. Una molestia que no se va en dos semanas la mira un fisio, no una app.',
  ...
  hintWeek1: 'Semana suave del bloque: RIR alto. Es la recuperación, no un día perdido.',
  ...
  weekPlanKicker: 'Tu semana',
  weekPlanNote: 'Lo que rota es la comida y la cena. El desayuno, la media mañana, el batido de antes del gym y la toma de antes de dormir son siempre los mismos: una cosa menos que decidir.',
  shoppingNote: '{0} de {1} artículos ya en el carro. Se guarda en este móvil, no se sincroniza.',
  shoppingTimes: '× {0} esta semana',
  shoppingClear: 'Vaciar la lista',
